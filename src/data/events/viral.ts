    ...
    choices: [
      {
        ...
        effects: { followers: 80000, fame: 15, energy: -30, mentalHealth: -10 },
        riskTag: "high_risk",
    ...
    choices: [
      {
        ...
        effects: { followers: 100000, fame: 18, energy: -20 },
        setFlags: ["celebrityNoticed"],
        riskTag: "big_opportunity",
        stakes: { upside: "100K followers, celebrity connection", downside: "Energy cost" },
        socialReaction: { type: "headline", text: "RISING CREATOR CATCHES CELEBRITY'S EYE" },
      },
      {
        id: "thank_humbly",
        text: "Post a humble thank you",
        effects: { followers: 50000, fame: 8, reputation: 15 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 75000, fame: 14, reputation: -8 },
        riskTag: "reputation_risk",
        stakes: { upside: "75K followers + fame", downside: "Reputation hit" },
        socialReaction: { type: "tweet", text: "they really said 'if you can't beat em' 💀", author: "@memepages" },
      },
      {
        id: "ignore_meme",
        text: "Pretend it's not happening",
        effects: { followers: 25000, fame: 5, reputation: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 50000, fame: 10, reputation: 5 },
      },
      {
        id: "create_more",
        text: "Drop 3 more sounds",
        effects: { followers: 35000, fame: 7, money: 8000, energy: -20 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 120000, fame: 22, reputation: 10, energy: -20 },
        riskTag: "big_opportunity",
        stakes: { upside: "120K followers, mainstream exposure", downside: "Energy drain" },
        socialReaction: { type: "headline", text: "INTERNET CREATOR GOES MAINSTREAM" },
      },
      {
        id: "stay_mysterious",
        text: "Decline — stay mysterious",
        effects: { followers: 40000, fame: 10, reputation: 15 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 60000, fame: 10, energy: -40, mentalHealth: -16 },
      },
      {
        id: "quality_content",
        text: "Drop one perfect video",
        effects: { followers: 35000, fame: 7, reputation: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 80000, fame: 15, energy: -30 },
      ...
      },
      {
        ...
        effects: { followers: 45000, fame: 8, reputation: 8 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 35000, fame: 7, reputation: 15 },
        setFlags: ["industryRespected"],
      },
      {
        id: "milk_it",
        text: "Make it all about you",
        effects: { followers: 65000, fame: 12, reputation: -12 },
        riskTag: "reputation_risk",
        stakes: { upside: "65K followers + fame", downside: "Reputation drop" },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 60000, fame: 15, money: 20000 },
        socialReaction: { type: "headline", text: "VIRAL CHALLENGE CREATOR CASHES IN" },
      },
      {
        id: "keep_it_free",
        text: "Keep it organic",
        effects: { followers: 100000, fame: 18, reputation: 15 },
        setFlags: ["industryRespected"],
      },
    ],
  },
