...
export const viralEvents: GameEvent[] = [
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: { followers: 7000, fame: 8, reputation: 10 },
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: { followers: 10000, fame: 8, reputation: 15 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: { followers: 5000, fame: 5, reputation: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 10000, fame: 10, reputation: 5 },
      },
      {
        id: "create_more",
        text: "Drop 3 more sounds",
        effects: { followers: 7000, fame: 7, money: 1500, energy: -20 },
      },
    ],
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effects: { followers: 8000, fame: 10, reputation: 15 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 12000, fame: 10, energy: -40, mentalHealth: -16 },
      },
      {
        id: "quality_content",
        text: "Drop one perfect video",
        effects: { followers: 8000, fame: 7, reputation: 10 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 18000, fame: 15, energy: -30 },
      ...
      },
      {
        ...
        effects: { followers: 10000, fame: 8, reputation: 8 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        effects: { followers: 15000, fame: 15, money: 4000 },
        socialReaction: { type: "headline", text: "VIRAL CHALLENGE CREATOR CASHES IN" },
      },
      {
        id: "keep_it_free",
        text: "Keep it organic",
        effects: { followers: 20000, fame: 18, reputation: 15 },
        setFlags: ["industryRespected"],
      },
    ],
  },
